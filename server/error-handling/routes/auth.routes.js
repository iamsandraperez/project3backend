...
router.post('/signup', (req, res, next) => {
    ...
    const { companyName, email, password, location, sector, contact, description } = req.body
    ...
    User
        ...
        .then((foundUser) => {
            ...
            return User.create({ companyName, email, password: hashedPassword, location, sector, contact, description })
        })
